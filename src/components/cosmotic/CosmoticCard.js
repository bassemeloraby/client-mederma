...
const CosmoticCard = ({ cosmotics, setUpdateProduct, user }) => {
  ...
  const singleCosmotic = cosmotics.filter((c) => c._id === id);
  console.log(singleCosmotic,"single");
        ...
        <section key={i} className="d-flex">
          ...
          <div className="12 col-6 ">
            <ListGroup className="list-group-flush">
              ...
              {c.price && <ListGroup.Item>price: {c.price} SR</ListGroup.Item>}
